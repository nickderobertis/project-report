...
MIT_LICENSE_PATH = PYTHON_DUNDER_VERSION_PROJECT_PATH / "LICENSE.md"
APACHE_LICENSE_PATH = PYTHON_SETUP_CFG_VERSION_PROJECT_PATH / "license.txt"
GPL_LICENSE_PATH = PYTHON_SETUP_PY_VERSION_PROJECT_PATH / "COPYING"
